...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('𝐌𝐨𝐯𝐢𝐞 𝐍𝐨𝐭 𝐅𝐨𝐮𝐧𝐝.𝙍𝙚𝙦𝙪𝙚𝙨𝙩 𝘽𝙮 𝙏𝙮𝙥𝙞𝙣𝙜 @𝙖𝙙𝙢𝙞𝙣 𝙖𝙣𝙙 𝙈𝙤𝙫𝙞𝙚/𝙎𝙚𝙧𝙞𝙚𝙨 𝙉𝙖𝙢𝙚.')
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("𝐌𝐨𝐯𝐢𝐞 𝐍𝐨𝐭 𝐅𝐨𝐮𝐧𝐝.𝙍𝙚𝙦𝙪𝙚𝙨𝙩 𝘽𝙮 𝙏𝙮𝙥𝙞𝙣𝙜 @𝙖𝙙𝙢𝙞𝙣 𝙖𝙣𝙙 𝙈𝙤𝙫𝙞𝙚/𝙎𝙚𝙧𝙞𝙚𝙨 𝙉𝙖𝙢𝙚.𝐧/𝐧/𝙀𝙭:@𝙖𝙙𝙢𝙞𝙣 𝘼𝙫𝙚𝙣𝙜𝙚𝙧𝙨")
    ...
    if not movielist:
        k = await msg.reply("❌ 𝙄 𝘾𝙤𝙪𝙡𝙙𝙣'𝙩 𝙁𝙞𝙣𝙙 𝘼𝙣𝙮𝙩𝙝𝙞𝙣𝙜 𝙍𝙚𝙡𝙖𝙩𝙚𝙙 𝙏𝙤 𝙏𝙝𝙖𝙩. 𝘾𝙝𝙚𝙘𝙠 𝙔𝙤𝙪𝙧 𝙎𝙥𝙚𝙡𝙡𝙞𝙣𝙜 𝙊𝙧 𝙎𝙚𝙣𝙙 𝙈𝙤𝙫𝙞𝙚/𝙎𝙚𝙧𝙞𝙚𝙨 𝙉𝙖𝙢𝙚 𝙊𝙣𝙡𝙮. 𝙄𝙛 𝙄𝙩'𝙨 𝙉𝙤𝙩 𝙁𝙤𝙪𝙣𝙙 𝙍𝙚𝙦𝙪𝙚𝙨𝙩 𝘽𝙮 𝙏𝙮𝙥𝙞𝙣𝙜 @𝙖𝙙𝙢𝙞𝙣 𝙖𝙣𝙙 𝙈𝙤𝙫𝙞𝙚/𝙎𝙚𝙧𝙞𝙚𝙨 𝙉𝙖𝙢𝙚. 𝘼𝙙𝙢𝙞𝙣𝙨 𝙒𝙞𝙡𝙡 𝙐𝙥𝙡𝙤𝙖𝙙 𝘼𝙣𝙙 𝙄𝙣𝙛𝙤𝙧𝙢 𝙔𝙤𝙪. n/n/⚜️ 𝙀𝙭 : @𝙖𝙙𝙢𝙞𝙣 𝘼𝙫𝙚𝙣𝙜𝙚𝙧𝙨")
        await asyncio.sleep(8)
        await k.delete()
        return
